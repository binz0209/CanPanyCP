...
public class MessagesControllerTests
{
    ...
    public async Task SendMessage_ShouldReturnSuccess_WhenValid()
    {
        // Arrange
        var userId = "user123";
        var request = new SendMessageRequest("conv123", "Hello, how are you?");
        ...
        _messageServiceMock.Setup(x => x.SendAsync(request.ConversationId, userId, request.Text))
    ...
    public async Task SendMessage_ShouldReturnUnauthorized_WhenUserNotAuthenticated()
    {
        ...
        var request = new SendMessageRequest("conv123", "Hello");
    ...
    [Fact]
    public async Task GetMessages_ShouldReturnSuccess_WhenConversationIdProvided()
    {
        // Arrange
        ...
        var messages = new List<Message>
        {
            ...
            new Message { Id = "msg2", ConversationId = conversationId, SenderId = "receiver456", Text = "Hi there" }
        };
        
        _messageServiceMock.Setup(x => x.GetByConversationIdAsync(conversationId, 1, 50))
    ...
    public async Task MarkConversationAsRead_ShouldReturnSuccess_WhenValid()
    {
        ...
        var userId = "user123";
        var conversationId = "conv123";
        _messageServiceMock.Setup(x => x.MarkConversationAsReadAsync(conversationId, userId))
            .ReturnsAsync(2);
