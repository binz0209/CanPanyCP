...
export function ApplicationStatusActionsCard({
    ...
    return (
        <Card className="p-6">
            <h2 className="text-lg font-semibold text-gray-900">Thao tác xét duyệt</h2>
            {canReviewStatus ? (
                <div className="mt-5 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            placeholder="Nhập lý do từ chối để gửi thông báo cho ứng viên"
                ...
                <p className="mt-4 text-sm text-gray-600">
                    Hồ sơ này đã được xử lý, không thể thay đổi trạng thái nữa.
                </p>
            )}
        </Card>
    );
