...
import { CandidateProfilePage, CandidateDashboardPage, CVListPage, AICVPage, ApplicationHistoryPage, JobAlertsPage, NotificationCenterPage } from '@/pages/candidate';
