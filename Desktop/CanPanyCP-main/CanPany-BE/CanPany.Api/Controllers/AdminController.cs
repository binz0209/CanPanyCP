...
public class AdminController : ControllerBase
{
    ...
    /// <summary>
    /// UC-ADM-27: Get All Reports (Admin)
    /// </summary>
    [HttpGet("reports")]
        ...
        [FromQuery] DateTime? toDate = null)
    {
        try
        {
            var filter = new ReportFilterDto(status, null, fromDate, toDate);
    ...
    /// <summary>
    /// UC-ADM-28: Get Report Details (Admin)
    /// </summary>
    [HttpGet("reports/{id}")]
    ...
    /// <summary>
    /// UC-ADM-29: Resolve Report (Admin)
    /// </summary>
    ...
    public async Task<IActionResult> ResolveReport(string id, [FromBody] ResolveReportRequest request)
    {
        try
        {
            ...
            if (!succeeded)
                return NotFound(ApiResponse.CreateError("Report not found or already resolved", "NotFound"));
